                            ...
                            <div class="col-xl-5 col-lg-5 col-md-9">
                                <div class="footer-item has-desc">
                                    <div class="footer-logo mb-25">
                                        <img src="<?= $env['APP_URL']?>assets/public/img/logo/logo2.png" width="120" height="31" alt="">
                                    </div>
                                    ...
                                    <div class="footer-img mt-65">
                                        <img src="<?= $env['APP_URL']?>assets/public/img/logo/paypal.png" alt="">
                                    </div>
                                </div>
                            </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script src="<?= $env['APP_URL']?>assets/public/js/jquery-ui.js"></script>
